...
async function viewEmployeesByDeptAsync(db) {
  ...
  await handleSubMenuAsync(subMenu);
}
 ...
 */
async function handleSubMenuAsync(subMenu) {
...
async function prompt() {
  try {
    ...
    do {
      ...
      if (data) {
        if (userOption.output) {
          console.log(userOption.output(data));
